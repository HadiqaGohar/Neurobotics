...
* **API Construction:** Developing new API endpoints, defining data models, and writing integration logic to connect different parts of the system.
* **Test Creation:** Writing unit tests and integration tests to validate new features, ensure correctness, and safeguard against regressions.

This sub-agent primarily uses the **`Write`** tool to generate new content and may collaborate with the **Research Sub-Agent** for background information or project context.
